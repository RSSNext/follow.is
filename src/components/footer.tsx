          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-5 lg:gap-12">
            ...
            >
              ...
              <p className="mb-6 max-w-md leading-relaxed text-gray-300">
                The next-generation information browser that transforms how you discover, consume,
                and interact with content across the web.
              </p>
              ...
              <div className="flex items-center gap-4">
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="group flex h-10 w-10 items-center justify-center rounded-full bg-gray-800 transition-colors hover:bg-gray-700"
                  >
