export default function GithubTrending() {
  return (
    <svg className="max-h-full" data-date-format="longDate" height="55" viewBox="0 0 250 53" width="250" xmlns="http://www.w3.org/2000/svg">
