export default function GithubTrending() {
  return (
    <svg className="max-h-full" data-date-format="longDate" height="55" width="250" viewBox="0 0 250 53" xmlns="http://www.w3.org/2000/svg">
      <rect fill="#111111" height="53" rx="10" x="0.5" y="0.5" />
      <svg height="45" width="48" version="1.1" viewBox="0 0 80 80" x="0" xmlns="http://www.w3.org/2000/svg" y="8">
